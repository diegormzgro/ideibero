...
$sql = "UPDATE catg_lecturas SET Eliminado = 1 WHERE idLectura = '$id' ";
$registro = mysqli_query($conexion,$sql);

$consulta ="SELECT a.idMateria, a.idSesion FROM catg_sesiones a 
			INNER JOIN  catg_lecturas as l ON l.idMateria= a.idSesion
...
echo '<td>
       ...
       echo' <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0" >
            ...
            WHERE cm.Eliminado=0 AND d.Estatus=1 AND a.Eliminado=0  AND d.idDocente='$idDoc' AND cm.idMateria='$idSesion'
