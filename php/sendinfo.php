<?php 
  ...
  //variables para los datos del archivo 
	if ($carrera==2) {
    $nombrearchivo = "MDCYDH2021.pdf";
    $archivo = "MDCYDH2021.pdf";	
	...
	elseif($carrera==4){
	$nombrearchivo = "DDCYDH2021.pdf";
    $archivo = "DDCYDH2021.pdf";
...
Te ofrecemos una Beca del 70% + 5% en inscripción, re-inscripción y mensualidades si te inscribes antes del 15 de enero de 2021.
...
Te ofrecemos una Beca del 70% + 5% en inscripción, re-inscripción y mensualidades si te inscribes antes del 26 de febrero de 2021.
