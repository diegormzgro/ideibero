...
<br>
    ...
    <script type="text/javascript">
         $('#Ma1').click(function(){
            $('#contenido').load("php/listar_grupos.php?id_Posgrado=1");
        });
         $('#Ma2').click(function(){
            $('#contenido').load("php/listar_grupos.php?id_Posgrado=2");
        });
          $('#Do1').click(function(){
            $('#contenido').load("php/listar_grupos.php?id_Posgrado=3");
        });
          $('#Do2').click(function(){
            $('#contenido').load("php/listar_grupos.php?id_Posgrado=4");
        });
        $('#Estudiante').click(function(){
            $('#contenido').load("php/listar_perfilGeneral.php");
            $('.tooltip').remove();
        });
