...
<div class="col">
   ...
   <div class="col">
    ...
    <li class="list-group-item"><a data-toggle="tab" href="#menu1" > Estudiantes</a></li>
...
WHERE u.id_perfil=1 AND u.id_posgrado=1 AND u.eliminado=0";
            ...
            <td>
              ...
              <a href="javascript:editarPerfil('.$renglon['id'].');"><i class="fas fa-address-book"></i></a>
...
WHERE s.id=1 AND a.Eliminado=0";
