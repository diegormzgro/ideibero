...
<div class="card-body">
          ...
          WHERE d.Eliminado=0 AND a.idMateria='$idMateria' AND u.id='$idAlumno'  AND t.Tarea_tipo=0 AND t.Eliminado=0 AND u.bloqueado=0 AND u.eliminado=0 AND u.emailInst<>''
