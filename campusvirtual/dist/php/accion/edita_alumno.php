...
if ($_POST['doct_universidad']!="") {
$doct_universidad = $_POST['doct_universidad'];
}else{
  $doct_universidad ="";
}
if ($_POST['doct_pais_e']!="") {
...
$doc_cert = $_POST['doc_cert'];
    ...
    mensualidad_pago='$monto_pagar_mensualidad', mensualidad_pagado='$monto_pagado_mensualidad', mensualidad_fecha='$fecha_pago_mensualidad', doc_cv='$doc_cv',doc_cert='$doc_cert',emailInst='$emailInst', pass='$pass', id_grupo='$grupo'
