...
$nuevo_msj ='El Instituto Iberoamericano de Derecho Electoral le informa que usted ha eliminado su trabajo final correspondiente a la asignatura '.$Materia.'
...
Instituto Iberoamericano de Derecho Electoral';
  ...
  $subjet = "Notificación/ Eliminación de Trabajo Final";
  $mensaje =  $nuevo_msj;
  $headers = "From:". $from;
