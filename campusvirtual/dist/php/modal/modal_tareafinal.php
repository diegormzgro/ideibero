...
?>
     <div class="modal fade bd-example-modal-xl" id="registra-tareafinal" tabindex="-1" role="dialog" aria-labelledby="registra-clase" aria-hidden="true">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="registra-tarea">Trabajo Final</h5>
 ...
 <div   id="mensaje"></div>
            ...
            <form onsubmit="return agregaTareaFinal();" id="formulario_tareafinal" class="formulario">
            ...
            <div class="form-group row">
             <div class="col-12 col-md-4 mb-2">
                  <label for="Docente">Sitio Web:</label>
                  <input name='Link' id='Link' class="form-control" type="text " >
              </div>
              <div class="col-12 col-md-4 mb-2">  
                  <label for="Docente">Fecha de Entrega:</label>
                  <input name='fecha' id='fecha' class="form-control" type="date"  min='1900-04-25' max="2999-12-31"  required>
              </div>
              <div class="col-12 col-md-4 mb-2"> 
