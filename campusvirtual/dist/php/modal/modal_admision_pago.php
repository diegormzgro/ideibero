   ...
   <div class="modal fade bd-example-modal-xl" id="registra-alumno" tabindex="-1" role="dialog" aria-labelledby="Eje" aria-hidden="true">
      ...
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
         ...
         <h5 class="modal-title" id="alumno" > <center >Pagos alumnos</center></h5>
...
<!--    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link waves-light active show" id="awesome-tab-classic-orange" data-toggle="tab" href="#awesome-classic-orange"
  ...
  <div class="tab-content card" id="myClassicTabContentOrange">
    ...
    <div class="tab-pane fade active show" id="awesome-classic-orange" role="tabpanel" aria-labelledby="awesome-tab-classic-orange">
          <div class="panel panel-primary">
            <div class="panel-heading">
