...
<center>
                        <h1 class="mt-4">Interesados</h1></center>
                        
            <center><button type="button" class="btn btn-primary" id="nuevo_alumno">Nuevo alumno</button></center>
       <div class="col" align="right">
          <button type="button" class="btn btn-warning" id="AdmisionHistorica">Admisiones Histórica</button>
       </div>                   
...
WHERE  u.emailInst ='' AND u.eliminado=0 AND u.id_posgrado IN (1,2,3,4)
GROUP BY u.email_particular, u.id_posgrado
