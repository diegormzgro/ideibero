...
if(($_SESSION['emailInst'])!=''){
    ...
    $idPos = $_GET['idPosgrado'];
?>

 <script src="js/myjava.js"></script>
<center> <h1 class="mt-4">Estudiantes / Pagos</h1></center>
                  
           <div class="card mb-3"  id="agrega-registros">
        <div class="card-header">
          <i class="fa fa-table"></i> Perfil 
    <div class="col" align="right">
     <?php echo '<a href="javascript:regresar('.$idPos.');">'; 
          ?>
...
WHERE u.id_perfil<>0 AND u.id_grupo='$idPos' AND u.emailInst<>''";
            ...
            <td>
              <a href="javascript:listar_alumnos('.$renglon['id'].');"><i class="btn-outline-success far fa-eye"></i>
  ...
  <?php  include("modal/modal_admision.php"); ?>
    ...
    <script type="text/javascript">
     function regresar(id){
      $('#contenido').load("php/listar_gruposPagos.php?id_Posgrado="+id);
      }
       function listar_alumnos(idAlumno){
